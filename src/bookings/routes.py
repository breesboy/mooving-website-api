...
async def update_booking(booking_uid:str, update_booking_data: UpdateBooking, session:AsyncSession = Depends(get_session)) -> dict:
...
async def reschedule_booking(booking_uid:str, reschedule_booking_data: RescheduleBooking, session:AsyncSession = Depends(get_session)) -> dict:
...
async def update_booking_status(booking_uid:str, booking_status_data: UpdateBookingStatus, session:AsyncSession = Depends(get_session)) -> dict:
...
async def cancel_booking(booking_uid:str, session:AsyncSession = Depends(get_session)) -> dict:
